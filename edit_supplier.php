<?php 
    ...
    $tampil = mysqli_query($koneksi, "SELECT * FROM t_supplier WHERE id_supplier = '$_GET[id_supplier]'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Form Edit Supplier</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <form action="update_supplier.php" method="POST">
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" name="nama_organisasi" value="<?php echo "$data[nama_organisasi]"; ?>" class="form-control" />
                                                                    <input type="hidden" name="id_supplier" value="<?php echo "$data[id_supplier]"; ?>" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
